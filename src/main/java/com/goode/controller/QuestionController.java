...
public class QuestionController {
  ...
  public ResponseEntity<?> getAllQuestions(@PathVariable("idGroup") int idGroup){
    ...
    return new ResponseEntity<>(questionService.getQuestionsByIdGroup(idGroup), HttpStatus.OK);
  }
